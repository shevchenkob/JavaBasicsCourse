...
Determine - considering the current date - when the student will complete the course;
Calculate how many days and hours the student still has before the end of the program or how many days and hours ago the student completed the course;
Student data is set in code;
Unit tests to cover the most important methods (assuming that unit testing framework dependency could be added using Maven/Gradle)
